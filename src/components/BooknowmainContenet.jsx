...
//     return (<>
//      <main className={`flex flex-col lg:flex-row w-full px-auto relative`}>
//         {/* Main Content Section */}
//         <div className={`relative transition-all duration-500 ease-in-out lg:w-[70%] w-full p-4 sm:p-6 lg:p-8 ${isBig ? "h-auto" : "h-[400px] sm:h-[500px] md:h-[600px] overflow-hidden"}`}>
//             <section className="p-4 sm:p-6 lg:p-8 font w-full bg-white rounded-lg shadow-sm border border-gray-100">
...
//                 {/* Add padding bottom to ensure button doesn't overlap content */}
//                 <div className="pb-16 sm:pb-20"></div>
//             </section>
            
//             {/* Read More/Less Button - positioned at bottom center of main content */}
//             <button
//                 className="absolute bottom-4 left-1/2 transform -translate-x-1/2 cursor-pointer rounded-[50px] font-[Montserrat] text-xs sm:text-[12px] font-medium leading-[18px] text-white font-bold py-2 px-4 hover:bg-red-600 transition-colors duration-300 h-[32px] sm:h-[38px] w-[100px] sm:w-[128px] bg-[#C64A30] z-10"
...
//         {/* Sidebar Cards Section - Only 3 Cards */}
//         <div className={`lg:w-[30%] w-full p-4 sm:p-6 lg:p-8 relative`}>
//             <div className={`flex flex-col gap-[15px] sm:gap-[20px] transition-all duration-500 ease-in-out ${isBig ? "h-auto" : "h-[400px] sm:h-[500px] md:h-[600px] overflow-hidden"}`}>
//                 <Card 
...
//             {/* Gradient overlay for sidebar when collapsed */}
//             {!isBig && (
